...
public class UserDAO {
	...
	public void save(User transientInstance) {
		transientInstance = new User("¿÷À…", "123", 1);
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getCurrentSession().get("com.jc.dao.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.jc.dao.User").add(Example.create(instance)).list();
